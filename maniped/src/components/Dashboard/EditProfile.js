...
class EditProfile extends React.Component {
    ...
    <div className='editProfileWrapper'>
        ...
        {this.state.editingUsername && <EditProfileForm thing='username' name='username'/>}
        <p onClick={this.openForm} name='editingEmail' value={this.state.editingEmail} className='editProfile'>Email: {this.props.email}</p>
        {this.state.editingEmail && <EditProfileForm thing='email' name='email'/>}
        ...
        {this.state.editingPhoneNumber && <EditProfileForm thing='phone number' name='phone_number'/>}
        ...
        {this.state.editingPrimaryAddress && <EditProfileForm thing='primary address' name='address'/>}
        ...
        {this.state.editingZip && <EditProfileForm thing='zipcode' name='zipcode'/>}
    </div>
    )
    }
}
